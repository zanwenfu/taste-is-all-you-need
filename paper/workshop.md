...
Live keeps the undercount and loses the resolve rates, at most 6 of 40 even rot-aware. Rollback broke 147 test functions across 6 of 39 runs, none still failing, though 25 of the 39 shipped an unchanged tree, against Verified's 104 across 6 on oracles twenty times larger. The gate contaminated two trees here, one of them after passing every check (Appendix C). No recovery left all 30 of its own (p = 0.125). The stack difference did not replicate (3 of 39 against 6, p = 0.24).
