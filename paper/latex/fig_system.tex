...
\node[box] (recov)   at (10.85,4.35) {\textbf{Recovery}\\rollback $\cdot$ repair $\cdot$ none};
...
\draw[draw=mute, dashed, dash pattern=on 2pt off 1.5pt, rounded corners=2pt]
  (0.8,3.05) rectangle (12.35,5.38);
\node[lab, anchor=west, font=\footnotesize\scshape] at (0.85,5.05) {pinned container};
...
\draw[gate] (9.38,1.12) -- (8.70,1.12) |- (monitor.south);
