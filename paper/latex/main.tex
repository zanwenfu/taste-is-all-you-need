...
\begin{figure}[t]\centering\includegraphics[width=0.82\linewidth]{fig_contrast.pdf}\caption{The five recovery arms under the GPT-5.6 stack on the same 40 instances. Contamination counts cells whose final patch fails a previously-passing test.}\label{fig:fig-contrast}\end{figure}
