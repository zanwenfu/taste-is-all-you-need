...
\textbf{Compute.} Every run, replay, and grade executed on one 12-vCPU, 22 GB x86 virtual machine running Docker, with no GPUs; the Verified sweeps reported cost about \$90 in model spend, the calibration and pilots a comparable amount, and the Live sweeps are reported with their own spend in Table 1.
