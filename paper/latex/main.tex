...
\begin{figure}[t]\centering\includegraphics[width=0.86\linewidth]{fig_undercount.pdf}\caption{Every run that produced at least one regression event, in both GPT-5.6 sweeps: events recorded on the timeline (red) against held-out test failures visible in the graded final patch (grey).}\label{fig:fig-undercount}\end{figure}
