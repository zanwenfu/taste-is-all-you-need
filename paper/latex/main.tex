...
\textbf{What to build differently.} A recovery monitor should run tests, not trust a model-written check. A benchmark should report what broke during the run beside the final verdict.
