    ...
    while i < len(lines):
        ...
        if ln.startswith("Table: "):
            ...
            out.append(r"\begin{table}[t]\caption{" + inline(caption) + "}\label{tab:" + label + "}"
                       + "\n" + table(rows).replace(r"\begin{center}\footnotesize", r"\centering\scriptsize\setlength{\aboverulesep}{0pt}\setlength{\belowrulesep}{0pt}\renewcommand{\arraystretch}{0.92}").replace(r"\end{tabular}\end{center}", r"\end{tabular}")
